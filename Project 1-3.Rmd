...
According to the above steps, we conclude that the two subgroups vary in their variance,so we choose t-tast to test the difference in homeprice between coastline MSAs and non-coastline MSAs.

* $H_0: \mu_{=1}=\mu_{=0}$ vs.$H_A:\mu_{=1}\neq\mu_{=0}
```{r}
